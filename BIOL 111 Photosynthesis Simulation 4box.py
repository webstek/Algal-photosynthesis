...
##############################################################################
                               #Variables#
##############################################################################
T = 50 #number of trials to complete
...
#Checks to see if O2 --> CO2 should happen
    for i in range(0,(n+1)**2):
        if SP1[0][i]>=0 and (SP1[0][i])<=pr and SP1[1][i]-pry>=0 and SP1[1][i]<=pr:
            SP1[4][i]=1
        if SP1[0][i]>=n-pr and (SP1[0][i])<=n and SP1[1][i]-pry>=0 and SP1[1][i]<=pr:
            SP1[4][i]=1
        if SP1[0][i]>=0 and (SP1[0][i])<=pr and SP1[1][i]-pry>=n-pr and SP1[1][i]<=n:
            SP1[4][i]=1
        if SP1[0][i]>=n-pr and (SP1[0][i])<=n and SP1[1][i]-pry>=n-pr and SP1[1][i]<=n:
            SP1[4][i]=1
...
#Function that switchs points between being O2 and CO2 molecules given they are in a region
        if j%tphot==0:
            for i in range(0,(n+1)**2):
                if SP1[0][i]>=0 and (SP1[0][i])<=pr and SP1[1][i]>=0 and SP1[1][i]<=pr:
                    SP1[4][i]=1
                if SP1[0][i]>=n-pr and (SP1[0][i])<=n and SP1[1][i]>=0 and SP1[1][i]<=pr:
                    SP1[4][i]=1
                if SP1[0][i]>=0 and (SP1[0][i])<=pr and SP1[1][i]>=n-pr and SP1[1][i]<=n:
                    SP1[4][i]=1
                if SP1[0][i]>=n-pr and (SP1[0][i])<=n and SP1[1][i]>=n-pr and SP1[1][i]<=n:
                    SP1[4][i]=1
...
#Now, we want to plot a graph of the normal model of these points.
#x = np.linspace(O2_avg - 3*O2_sd, O2_avg + 3*O2_sd, 100)
#We need a matrix of the z-scores
#O2_z = np.zeros((1,T))
#for i in range(0,T):
#    O2_z[0][i] = O2_dlt[0][i] / O2_sd
